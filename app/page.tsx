      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-8">
        ...
        {projects.length === 0 ? (
          <EmptyState
            ...
            description="Créez votre premier projet de rénovation et laissez notre assistant IA vous guider dans la planification et la gestion de vos travaux."
            action={{
            ...
            secondaryAction={{
              ...
              onClick: () => {
                // Will implement tour later
                alert('Tour guidé à venir !');
              },
            }}
          >
            <div className="flex items-center justify-center gap-6 mt-4 mb-6 text-sm text-gray-600">

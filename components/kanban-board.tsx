...
export function KanbanBoard({ tasks }: KanbanBoardProps) {
  ...
  // Détection du scroll sur mobile pour pagination dots
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const columnWidth = container.offsetWidth * 0.85; // 85vw par colonne
    ...
    <div>
      ...
      <div className="md:hidden">
        <div 
          ...
          className="flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory -mx-4 px-4 scrollbar-hide"
        ...
        >
          {columns.map((column) => (
            <div
              key={column.status}
              className={cn(
                'flex-shrink-0 w-[85vw] rounded-lg p-4 min-h-[500px] snap-start',
                column.color
              )}

...
## Communication
11. Markdown lisible (titres, listes courtes, tableaux si besoin).
12. Émojis pertinents (🏠 🔨 💰 ✅ ⚠️).
13. Sections **courtes** et actionnables.
...
export const INITIAL_ASSISTANT_MESSAGE = `Bonjour 👋 Je suis **RenovAI**, votre assistant expert en rénovation.
...
- "Ajoute des meubles pour le salon à ma liste"
